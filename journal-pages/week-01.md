...
To collect the data, I carried a piece of A4 paper with me and made a quick note each time I picked up my phone. I recorded the time, what I was doing before picking it up, and how I felt in that moment. I also wrote the main reason for using it, such as checking messages, social media, music, or just unlocking it without a clear purpose. After collecting all of the data I created a time map from 9am - my usual wake up time, to 11pm - my usual bed time. I then created circles with colours, based on my emotions and the time I spent on the phone.
